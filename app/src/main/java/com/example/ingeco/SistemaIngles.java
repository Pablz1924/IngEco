...
public class SistemaIngles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sistema_ingles);
    ...
    public void calcular(View view){
        ...
        Row0.addView(pago);
        TextView Mrenta = newTextView(" Interes ", "#FF000000");
        Row0.addView(Mrenta);
        TextView interes1 = newTextView("  Mensualidad Renta   ", "#FF000000");
        ...
        Double Saldo = 0.0;
        TextView new_col1, Interes2, Mensualidad3, Amortizacion4, Saldo5;
        ...
        for (int i = 0; i < n; i++){
            ...
            if (i == (n-1)) {
                ...
                Interes2 = newTextView(df.format(Interes),"#FF000000");
                Mensualidad3 = newTextView(df.format(Mensualidad),"#FF000000");
                Amortizacion4 = newTextView(df.format(Amortizacion),"#FF000000");
            ...
            newRow.addView(Interes2);
            newRow.addView(Mensualidad3);
            newRow.addView(Amortizacion4);
